 ...
 */
class UnUseUxActivity : ZBaseActivity() {

    private val zFastFileSelectorUtils = ZFastFileSelectorUtils()

    override fun bindLayout() = R.layout.activity_un_use_ux

    override fun initView(view: View?, savedInstanceState: Bundle?) {

        baseUI.setCommonTitleStyleAutoBackground(ZCommonResource.getBackIcon(), "不使用UX框架")

        zFastFileSelectorUtils.register(baseUI.initUI)
    }

    override fun isAutoSetStatusBarColor() = false
